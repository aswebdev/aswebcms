...
<script type="text/javascript" src="<?php echo BASE_URL_CMS; ?>includes/js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?php echo BASE_URL_CMS; ?>includes/js/main.min.js"></script>
