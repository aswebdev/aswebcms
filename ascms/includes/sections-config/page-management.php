...
$adminVariables['PAGE-MANAGEMENT']['DB-FIELDS'] = array('TITLE','DESCRIPTION','HTML-CONTENT','SEO-URL','DATE-MODIFIED','ACTIVE'); // Fields to save in the database
...
$adminVariables['PAGE-MANAGEMENT']['FORM-ELEMENTS'] = array(
	'TITLE' => array('TYPE' => 'text', 'LABEL' => 'Page Title', 'REQUIRED' => 'true', 'VALIDATION-MESSAGE' => 'Enter the Page Title', 'DATABASE-FIELD' => 'TITLE', 'DESCRIPTION' => 'The Title of the Page (use between 100-200 Characters)', 'STYLES' => array('width' => '370px'), 'PLACEHOLDER' => 'Enter a Page Title'),
	...
	'SEO-URL' => array('TYPE' => 'text-url', 'LABEL' => 'SEO URL', 'REQUIRED' => 'true', 'VALIDATION-MESSAGE' => 'Enter an SEO URL', 'DATABASE-FIELD' => 'SEO-URL', 'DESCRIPTION' => 'Enter the Search Engine safe URL that will be displayed (E.g /product-list/ or /about-us/)'),
