...
if( $userLoggedIn == true ) {
	...
	if( is_array( $pageListVariables ) ) {
        ...
        foreach( $pageListVariables as $pageId => $pageSettings ) {
			...
			echo "><a href=\"".BASE_URL_CMS."module.php?module=".urlencode($pageId)."\" title=\"".htmlspecialchars($pageSettings['TITLE'])."\"><i class=\"fa fa-" . $pageSettings['ICON'] . "\"></i>&nbsp;".$pageSettings['TITLE']."</a>";
    ...
    echo "<li><a href=\"" . BASE_URL_CMS . "index.php?action=logout\" title=\"Logout\"><i class=\"fa fa-arrow-left\"></i>&nbsp;Logout</a></li>";
