...
$adminVariables['PRODUCT-MANAGEMENT']['FORM-ELEMENTS'] = array(
	...
	'IMAGE-FILENAME' => array('TYPE' => 'upload', 'SAVE-DIRECTORY-DIST' => 'dist/img/', 'SAVE-DIRECTORY-TMP' => 'dev/tmp/', 'SAVE-DIRECTORY' => 'dev/img/', 'LABEL' => 'Product Image Upload', 'REQUIRED' => '', 'VALIDATION-MESSAGE' => '', 'DATABASE-FIELD' => 'IMAGE-FILENAME', 'DESCRIPTION' => 'Product Image File (JPEG, PNG or GIF file)', 'FILE-TYPES' => array('png','jpg','jpeg','gif'), 'ALTERNATE-UPLOAD-SIZES' => array('100x100') , 'FILE-APPEND' => '_PRODUCT'),
