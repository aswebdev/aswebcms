...
$adminVariables['PAGE-MANAGEMENT']['FORM-ELEMENTS'] = array(
	...
	'SEO-URL' => array('TYPE' => 'text-url', 'LABEL' => 'SEO URL', 'REQUIRED' => 'true', 'VALIDATION-MESSAGE' => 'Enter the SEO Slug', 'DATABASE-FIELD' => 'SEO-URL', 'DESCRIPTION' => 'The Search Engine safe URL to be shown in the address bar', 'PLACEHOLDER' => 'Enter a URL slub. E.g my-page'),
