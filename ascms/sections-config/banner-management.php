...
$adminVariables['BANNER-MANAGEMENT']['FORM-ELEMENTS'] = array(
    ...
    'IMAGE-FILENAME' => array('TYPE' => 'upload', 'SAVE-DIRECTORY' => 'dev/images/', 'LABEL' => 'Banner Image Upload', 'REQUIRED' => '', 'VALIDATION-MESSAGE' => '', 'DATABASE-FIELD' => 'IMAGE-FILENAME', 'DESCRIPTION' => 'Product Image File (JPEG, PNG or GIF file)', 'FILE-TYPES' => array('png','jpg','jpeg','gif'), 'FILE-APPEND' => '_BANNER') ,
